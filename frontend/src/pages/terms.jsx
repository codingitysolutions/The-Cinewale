...
export default function Terms() {
  ...
  return (
    <div id="terms-container" dangerouslySetInnerHTML={{ __html: `<!doctype html>
...
<base href="/">
<meta charset="utf-8" />
<title>Terms & Conditions | The Cinewale</title>
...
<div style="background-color: #bb9978; width: 100%;">
  <div style="padding: 120px 5% 80px; max-width: 900px; margin: 0 auto; color: #fff; font-family: sans-serif;">
    <h1 style="text-align: center; margin-bottom: 60px; font-size: 2.8rem; color: #791112; letter-spacing: 2px;">TERMS & CONDITIONS</h1>
    
    <div style="font-size: 1.1rem; line-height: 1.8; color: #fff;">
      
      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">1. Booking & Payments</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">1.1. 10% non-refundable booking amount required to confirm dates</li>
        <li style="margin-bottom: 10px;">1.2. Dates are reserved only after payment and agreement confirmation</li>
        <li style="margin-bottom: 10px;">1.3. 70% payment due 30 days before the first event</li>
        <li style="margin-bottom: 10px;">1.4. Remaining 30% due on or before the last event</li>
        <li style="margin-bottom: 10px;">1.5. Payments accepted via bank transfer, UPI, cheque, or cash (Except Cash all other modes will attract GST @ 18%)</li>
        <li style="margin-bottom: 10px;">1.6. Delayed payments may result in delayed deliverables</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">2. Cancellation & Refund Policy</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">2.1. In case of cancellation by the client, the following applies:</li>
        <li style="margin-bottom: 5px; padding-left: 20px;">• 15–30 days before event: 20% deduction, balance refunded</li>
        <li style="margin-bottom: 10px; padding-left: 20px;">• 0–15 days before event: No refund</li>
        <li style="margin-bottom: 10px;">2.2. In case of cancellation by The Cinewale, full refund will be provided</li>
        <li style="margin-bottom: 10px;">2.3. Rescheduling allowed within 12 months (subject to availability)</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">3. Coverage & Team</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">3.1. Coverage will be as per the selected package</li>
        <li style="margin-bottom: 10px;">3.2. All creative decisions (shooting & editing style) remain with the studio</li>
        <li style="margin-bottom: 10px;">3.3. Photography and filming team will dine with guests at venue.</li>
        <li style="margin-top: 20px; font-weight: bold; color: #fff;">THIS PROPOSAL IS VALID FOR 14 DAYS.</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">4. Client Responsibilities</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">4.1. Obtain necessary venue permissions (photo/video/drone)</li>
        <li style="margin-bottom: 10px;">4.2. Provide meals and basic arrangements for the team during long events</li>
        <li style="margin-bottom: 10px;">4.3. Ensure cooperation and punctuality for scheduled shoots</li>
        <li style="margin-bottom: 10px;">4.4. Maintain backup of delivered data after final delivery</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">5. Copyright & Usage Rights</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">5.1. All photos and videos remain the property of The Cinewale</li>
        <li style="margin-bottom: 10px;">5.2. The studio may use selected work for portfolio and marketing</li>
        <li style="margin-bottom: 10px;">5.3. Clients receive personal usage rights only.</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">6. Drone & Equipment Policy</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">6.1. Drone usage depends on permissions and regulations</li>
        <li style="margin-bottom: 10px;">6.2. The studio is not liable for restrictions or denied permissions</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">7. Liability</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">7.1. Liability is limited to the total amount paid</li>
        <li style="margin-bottom: 10px;">7.2. While all precautions are taken, unforeseen technical/data issues are not the studio’s responsibility.</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">8. Time for Portraits & Special Shoots</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">8.1. Clients must allocate dedicated time for couple portraits and special shoots.</li>
        <li style="margin-bottom: 10px;">8.2. Delays or lack of time may affect the quality and variety of shots.</li>
        <li style="margin-bottom: 10px;">8.3. Best results require planned time before or between events.</li>
      </ul>

      <h2 style="color: #791112; font-size: 1.5rem; margin-top: 40px; margin-bottom: 15px;">9. Data Storage & Backup</h2>
      <ul style="list-style-type: none; padding-left: 0; margin-bottom: 30px;">
        <li style="margin-bottom: 10px;">9.1. Data will be stored for up to 30 days after delivery.</li>
        <li style="margin-bottom: 10px;">9.2. Post this, the studio is not responsible for data loss.</li>
        <li style="margin-bottom: 10px;">9.3. Clients should create backups after delivery</li>
      </ul>
