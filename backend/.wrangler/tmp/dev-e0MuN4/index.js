...
// .wrangler/tmp/bundle-4uOSP8/checked-fetch.js
...
var createCrudRoutes = /* @__PURE__ */ __name((path, tableName, insertCols, insertVars, getInsertValues) => {
...
app.delete("/api/admin/team/users/:id", async (c) => {
  ...
  if (id == 1) return c.json({ error: "Cannot delete master admin" }, 400);
